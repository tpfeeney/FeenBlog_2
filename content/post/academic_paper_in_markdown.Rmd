...
knitr::include_graphics("/Users/timf/Documents/GitHub/academic_abstract_in_markdown/basic.png")
```
...
```{r echo = F, out.width="75%"}
knitr::include_graphics("/Users/timf/Documents/GitHub/academic_abstract_in_markdown/augmented.png")
```
